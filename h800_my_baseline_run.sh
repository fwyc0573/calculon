...
# FP32 8GPUS 13B PP2TP4DP1
# calculon llm models/gpt3-13B.json examples/8gpu_gpt13b_tp4_pp2_dp1.json systems/h800_80g_nvl8.json results/h800/gpt3-13B_8gpu_PP2TP4DP1.json

# FP32 8GPUS 13B PP2TP2DP2
# calculon llm models/gpt3-13B.json examples/8gpu_gpt13b_tp2_pp2_dp2.json systems/h800_80g_nvl8.json results/h800/gpt3-13B_8gpu_PP2TP2DP2.json
# OOM

# FP32 8GPUS 13B PP4TP2DP1
calculon llm models/gpt3-13B.json examples/8gpu_gpt13b_tp2_pp4_dp1.json systems/h800_80g_nvl8.json results/h800/gpt3-13B_8gpu_PP4TP2DP1.json

# FP32 8GPUS 13B PP8TP1DP1
calculon llm models/gpt3-13B.json examples/8gpu_gpt13b_tp1_pp8_dp1.json systems/h800_80g_nvl8.json results/h800/gpt3-13B_8gpu_PP8TP1DP1.json




echo "All calculations completed. Results saved in results/h800 directory."